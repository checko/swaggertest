...
validators = {
    ('api', 'GET'): {'args': {'required': ['lang'], 'properties': {'lang': {'description': 'language', 'schema': {'type': 'string', 'example': 'es'}}}}},
}

filters = {
    ('api', 'GET'): {200: {'headers': None, 'schema': None}},
    ('users', 'GET'): {200: {'headers': None, 'schema': None}},
    ('user_userid_new', 'POST'): {200: {'headers': None, 'schema': None}, 400: {'headers': None, 'schema': None}},
}
